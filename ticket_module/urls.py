...
from .views import show_tickets,show_ticket_details,create_new_ticket_message,create_new_ticket,show_user_tickects,answer_ticket
urlpatterns=[
    ...
    path('create_new_ticket',create_new_ticket.as_view(),name='create_new_ticket'),
